    ...
    <div id="referrers" class="postbox ">
        ...
        <div class="inside">
            <table cellspacing="0">
                ...
                <tr>
                    <td align="left"> <span><?php echo __( 'All meteorological data provided by OpenWeatherMap are distributed under terms of the <a href="http://creativecommons.org/licenses/by-sa/2.0/" target="_blank">Creative Commons CC:BY-SA 2.0 license</a>.', 'live-weather-station');?></span><br/>&nbsp;</td>
                </tr>
