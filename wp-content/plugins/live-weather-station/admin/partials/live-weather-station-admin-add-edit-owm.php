    ...
    <form method="post" name="add-owm" id="add-owm" action="<?php echo esc_url( $this->get_page_url('manage_owm') ); ?>">
        ...
        <table class="form-table">
            <tr class="form-field form-required">
                ...
                <td><input required name="station_name" aria-required="true" type="text" id="station_name" value="<?php echo $station['station_name'] ?>" maxlength="60" style="width:25em;" /></td>
            </tr>
            <tr class="form-field form-required">
                ...
                <td><input required name="loc_city" type="text" id="loc_city" value="<?php echo $station['loc_city'] ?>" maxlength="60" style="width:25em;" /></td>
            </tr>
            <tr class="form-field form-required">
            ...
            <tr class="form-field form-required">
                ...
                <td><input required name="loc_altitude" type="text" id="loc_altitude" value="<?php echo $station['loc_altitude'] ?>" maxlength="20" style="width:25em;" /></td>
            </tr>
        </table>
