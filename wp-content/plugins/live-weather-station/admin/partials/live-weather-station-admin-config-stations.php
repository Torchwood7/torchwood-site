    ...
    <div id="normal-sortables" class="meta-box-sortables ui-sortable">
        <div id="referrers" class="postbox ">
            ...
            <div class="inside">
                <table cellspacing="0">
                    <tbody>
                    <?php if (!Owm_Client::is_owm_station($device['_id'])) { ?>
                    <tr>
                        ...
                        <td align="left">
                            <span>
                                ...
                                <?php esc_attr_e((array_key_exists('improveLocProposed', $device['place']) && $device['place']['improveLocProposed'] ) ?  __('Geolocation informations found', 'live-weather-station') :  __('Geolocation informations not found', 'live-weather-station')) ?>
                                <?php echo '<br />'; ?>
                    ...
                    <?php foreach($device['modules'] as $module) { ?>
                        ...
                        <?php if ($module['type'] != 'NACurrent' && $module['type'] != 'NAComputed' && $module['type'] != 'NAEphemer') { ?>
                        <tr>
