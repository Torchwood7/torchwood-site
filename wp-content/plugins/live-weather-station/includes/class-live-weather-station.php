...
require_once(LWS_INCLUDES_DIR.'class-owm-updater.php');
...
class Live_Weather_Station {
	...
	use Unit_Description, Type_Description, Unit_Conversion, Schedules_Manipulation, Options_Manipulation, Datas_Storage;
    ...
    private function define_cron_hooks() {
		...
		$plugin_owm_cron = new Owm_Updater( $this->get_Live_Weather_Station(), $this->get_version() );
