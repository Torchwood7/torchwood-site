...
trait Type_Description {
     ...
     * @param   string $abbr    Is the type must be abbreviated.
     * @return  string  The type of the measurement in plain text.
     * @since    1.0.0
     * @access   protected
     */
    protected function get_measurement_type ($type, $abbr=false) {
        switch (strtolower($type)) {
            case 'firmware':
            ...
            case 'signal':
                ...
                break;
            case 'co2':
                $result = ($abbr ? __('C0₂', 'live-weather-station') : __('C0₂ level', 'live-weather-station'));
                break;
            case 'humidity':
            ...
            case 'cloudiness':
                ...
                break;
            case 'rain':
                $result = ($abbr ? __('Rain', 'live-weather-station') : __('Rainfall', 'live-weather-station'));
                break;
            case 'snow':
                $result = ($abbr ? __('Snow', 'live-weather-station') : __('Snowfall', 'live-weather-station'));
                break;
